...
--
-- Name: games fkopponent; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fkopponent FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
